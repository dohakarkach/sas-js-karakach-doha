 ...
 *
 * 🎯 MISSION
 * Créez une fonction c(mot) qui prend "yOUcoDe" et retourne "Youcode" (seule la première lettre est en majuscule, le reste en minuscules).
 *
...
{ return mot [0] .toUpperCase() + mot.slice (1)+ mot . toLowerCase ();}
